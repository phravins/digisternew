defmodule Digister.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    field :metabase_id, :integer
    field :avatar, :binary
    field :avatar_content_type, :string
    field :two_fa_enabled, :boolean, default: false
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Digister.Repo)
  ...
  def valid_password?(%Digister.Accounts.User{hashed_password: hashed_password}, password)

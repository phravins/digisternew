defmodule DigisterWeb.SuperAdmin.CreateRegisterLive do
  ...
  def render(assigns) do
    ...
    <form phx-submit="save" class="flex-1 flex flex-col min-h-0 w-full">
      ...
      <%!-- Fields --%>
      <div class="bg-white rounded-xl border border-gray-200 p-6 flex-1 flex flex-col min-h-0">

        <h2 class="text-sm font-semibold text-gray-900 mb-4">Fields</h2>

        <%!-- All add-field buttons in one compact wrapping row --%>
        <div class="flex flex-wrap gap-2 pb-4 mb-4 border-b border-gray-100">
        ...
        <%= if @fields == [] do %>
          <div class="flex-1 flex items-center justify-center">
            <p class="text-sm text-gray-400 text-center">
              Click a field type above to start building your register.
            </p>
          </div>
        <% else %>
          <div class="space-y-2 overflow-y-auto flex-1">
            <div :for={field <- @fields}
              class="flex items-center gap-3 bg-gray-50 rounded-lg border border-gray-200 px-4 py-3">
